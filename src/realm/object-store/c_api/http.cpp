...
{
    auto transport = std::make_shared<realm_legacy::c_api::CNetworkTransport>(realm_legacy::c_api::UserdataPtr{userdata, free},
                                                                       request_executor);
...
{
    realm_legacy::c_api::CNetworkTransport::on_response_completed(completion_data, response);
}
