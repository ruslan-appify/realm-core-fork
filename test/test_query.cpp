...
TEST(Query_NextGen_StringConditions)
{
    ...
    cnt = table2->column<String>(col_str3).equal(realm_legacy::null()).count();
    CHECK_EQUAL(cnt, 1);

    cnt = table2->column<String>(col_str3).not_equal(realm_legacy::null()).count();
    CHECK_EQUAL(cnt, 4);

    cnt = table2->column<String>(col_str3).contains(realm_legacy::null()).count();
    CHECK_EQUAL(cnt, 5);

    cnt = table2->column<String>(col_str3).like(realm_legacy::null()).count();
    CHECK_EQUAL(cnt, 1);
    ...
    cnt = table2->column<String>(col_str3).equal(realm_legacy::null(), false).count();
    CHECK_EQUAL(cnt, 1);

    cnt = table2->column<String>(col_str3).not_equal(realm_legacy::null(), false).count();
    CHECK_EQUAL(cnt, 4);

    cnt = table2->column<String>(col_str3).contains(realm_legacy::null(), false).count();
    CHECK_EQUAL(cnt, 5);

    cnt = table2->column<String>(col_str3).like(realm_legacy::null(), false).count();
    CHECK_EQUAL(cnt, 1);
    ...
    cnt = table3->link(col_link1).column<String>(col_str3).equal(realm_legacy::null()).count();
    CHECK_EQUAL(cnt, 1);

    cnt = table3->link(col_link1).column<String>(col_str3).not_equal(realm_legacy::null()).count();
    CHECK_EQUAL(cnt, 4);
    ...
    cnt = table3->link(col_link1).column<String>(col_str3).equal(realm_legacy::null(), false).count();
    CHECK_EQUAL(cnt, 1);

    cnt = table3->link(col_link1).column<String>(col_str3).not_equal(realm_legacy::null(), false).count();
    CHECK_EQUAL(cnt, 4);

    cnt = table3->link(col_link1).column<String>(col_str3).contains(realm_legacy::null(), false).count();
    CHECK_EQUAL(cnt, 4);
    ...
    cnt = table3->link(col_link1).column<String>(col_str3).like(realm_legacy::null(), false).count();
    CHECK_EQUAL(cnt, 1);
}
...
TEST(Query_NextGenSyntaxMonkey)
{
    ...
    for (int iter = 1; iter < 5 * (TEST_DURATION * TEST_DURATION * TEST_DURATION + 1); iter++) {
        ...
        // second == 1
        realm_legacy::Query q1_0 = table.where().equal(col_int1, 1);
        realm_legacy::Query q2_0 = table.column<int64_t>(col_int1) == 1;
        realm_legacy::TableView tv_0 = q2_0.find_all();
        tvpos = 0;
        for (Obj o : table) {
        ...
        realm_legacy::Query q2_1 = (table.column<int64_t>(col_int0) == 0 || table.column<int64_t>(col_int0) == 1) &&
                            table.column<int64_t>(col_int1) == 1;
        realm_legacy::TableView tv_1 = q2_1.find_all();
        tvpos = 0;
        for (Obj o : table) {
        ...
        // first == 0 || (first == 1 && second == 1)
        realm_legacy::Query q2_2 = table.column<int64_t>(col_int0) == 0 ||
                            (table.column<int64_t>(col_int0) == 1 && table.column<int64_t>(col_int1) == 1);
        realm_legacy::TableView tv_2 = q2_2.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if (o.get<Int>(col_int0) == 0 || (o.get<Int>(col_int0) == 1 && o.get<Int>(col_int1) == 1)) {
        ...
        realm_legacy::Query q4_8 = table.column<int64_t>(col_int1) == 0 &&
                            (table.column<int64_t>(col_int0) == 0 || table.column<int64_t>(col_int0) == 2);
        realm_legacy::TableView tv_8 = q4_8.find_all();
        tvpos = 0;
        for (Obj o : table) {
        ...
        realm_legacy::Query q3_7 = (table.column<int64_t>(col_int0) == 0 || table.column<int64_t>(col_int0) == 2) &&
                            (table.column<int64_t>(col_int0) == 1 || table.column<int64_t>(col_int1) == 1);
        realm_legacy::TableView tv_7 = q3_7.find_all();
        tvpos = 0;
        for (Obj o : table) {
        ...
        // (first == 0 || first == 2) || (first == 1 || second == 1)
        realm_legacy::Query q4_7 = (table.column<int64_t>(col_int0) == 0 || table.column<int64_t>(col_int0) == 2) ||
                            (table.column<int64_t>(col_int0) == 1 || table.column<int64_t>(col_int1) == 1);
        realm_legacy::TableView tv_10 = q4_7.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if ((o.get<Int>(col_int0) == 0 || o.get<Int>(col_int0) == 2) ||
                (o.get<Int>(col_int0) == 1 || o.get<Int>(col_int1) == 1)) {
        ...
        // first == 0 || first == 2 || first == 1 || second == 1
        realm_legacy::Query q20 = table.column<int64_t>(col_int0) == 0 || table.column<int64_t>(col_int0) == 2 ||
                           table.column<int64_t>(col_int0) == 1 || table.column<int64_t>(col_int1) == 1;
        tv = q20.find_all();
        tvpos = 0;
        for (Obj o : table) {
        ...
        realm_legacy::Query q21 = table.query("first * 2 > second / 2 + third + 1");
        tv = q21.find_all();
        tvpos = 0;
        for (Obj o : table) {
        ...
        realm_legacy::Query q22 = table.query("first * 2 > second / 2 + third + 1 + third - third + third - third + third - "
...
TEST(Query_MergeQueriesOverloads)
{
    ...
    // q1_0 && q2_0
    realm_legacy::Query q1_110 = table.where().equal(col_int0, 20);
    realm_legacy::Query q2_110 = table.where().equal(col_int1, 30);
    realm_legacy::Query q3_110 = q1_110.and_query(q2_110);
    c = q1_110.count();
    c = q2_110.count();
    c = q3_110.count();
    ...
    // q1_0 && q2_0
    realm_legacy::Query q1_0 = table.where().equal(col_int0, 10).Or().equal(col_int0, 20);
    realm_legacy::Query q2_0 = table.where().equal(col_int1, 30);
    realm_legacy::Query q3_0 = q1_0 && q2_0;
    c = q3_0.count();
    CHECK_EQUAL(1, c);

    // q2_0 && q1_0 (reversed operand order)
    realm_legacy::Query q1_1 = table.where().equal(col_int0, 10).Or().equal(col_int0, 20);
    realm_legacy::Query q2_1 = table.where().equal(col_int1, 30);
    c = q1_1.count();

    realm_legacy::Query q3_1 = q2_1 && q1_1;
    c = q3_1.count();
    CHECK_EQUAL(1, c);

    // Short test for ||
    realm_legacy::Query q1_2 = table.where().equal(col_int0, 10);
    realm_legacy::Query q2_2 = table.where().equal(col_int1, 30);
    realm_legacy::Query q3_2 = q2_2 || q1_2;
    c = q3_2.count();
    CHECK_EQUAL(2, c);
}
...
TEST(Query_MergeQueries)
{
    ...
    realm_legacy::Query q1_0 = table.where().equal(col_int0, 10).Or().equal(col_int0, 20);
    realm_legacy::Query q2_0 = table.where().and_query(q1_0).equal(col_int1, 30);
...
TEST(Query_Not)
{
    ...
    realm_legacy::Query q0 = table.where().Not().equal(col_int0, 10);
    CHECK_EQUAL(2, q0.count());

    // grouping, after not
    realm_legacy::Query q0b = table.where().Not().group().equal(col_int0, 10).end_group();
    CHECK_EQUAL(q0b.validate(), "");
    CHECK_EQUAL(2, q0b.count());

    // grouping, surrounding not
    realm_legacy::Query q0c = table.where().group().Not().equal(col_int0, 10).end_group();
    CHECK_EQUAL(2, q0c.count());

    // nested nots (implicit grouping)
    realm_legacy::Query q0d = table.where().Not().Not().equal(col_int0, 10);
    CHECK_EQUAL(1, q0d.count()); // FAILS

    realm_legacy::Query q0e = table.where().Not().Not().Not().equal(col_int0, 10);
    CHECK_EQUAL(2, q0e.count()); // FAILS

    // just checking the above
    realm_legacy::Query q0f = table.where().Not().not_equal(col_int0, 10);
    CHECK_EQUAL(1, q0f.count());

    realm_legacy::Query q0g = table.where().Not().Not().not_equal(col_int0, 10);
    CHECK_EQUAL(2, q0g.count()); // FAILS

    realm_legacy::Query q0h = table.where().not_equal(col_int0, 10);
    CHECK_EQUAL(2, q0h.count());

    // should apply not to first term, leading to query "not A and A", which is obviously empty:
    realm_legacy::Query q1 = table.where().Not().equal(col_int0, 10).equal(col_int0, 10);
    CHECK_EQUAL(0, q1.count());

    // should apply not to first term, leading to query "not A and A", which is obviously empty:
    realm_legacy::Query q1b = table.where().group().Not().equal(col_int0, 10).end_group().equal(col_int0, 10);
    CHECK_EQUAL(0, q1b.count());

    // should apply not to first term, leading to query "not A and A", which is obviously empty:
    realm_legacy::Query q1c = table.where().Not().group().equal(col_int0, 10).end_group().equal(col_int0, 10);
    CHECK_EQUAL(0, q1c.count());


    // should apply not to second term, leading to query "A and not A", which is obviously empty:
    realm_legacy::Query q2 = table.where().equal(col_int0, 10).Not().equal(col_int0, 10);
    CHECK_EQUAL(0, q2.count()); // FAILS

    // should apply not to second term, leading to query "A and not A", which is obviously empty:
    realm_legacy::Query q2b = table.where().equal(col_int0, 10).group().Not().equal(col_int0, 10).end_group();
    CHECK_EQUAL(0, q2b.count());

    // should apply not to second term, leading to query "A and not A", which is obviously empty:
    realm_legacy::Query q2c = table.where().equal(col_int0, 10).Not().group().equal(col_int0, 10).end_group();
    CHECK_EQUAL(0, q2c.count()); // FAILS


    // should apply not to both terms, leading to query "not A and not A", which has 2 members
    realm_legacy::Query q3 = table.where().Not().equal(col_int0, 10).Not().equal(col_int0, 10);
    CHECK_EQUAL(2, q3.count()); // FAILS

    // applying not to an empty query is forbidden
    realm_legacy::Query q4 = table.where();
    CHECK_THROW(!q4, realm_legacy::Exception);
}
...
TEST(Query_MergeQueriesMonkey)
{
    ...
    for (int iter = 0; iter < 5; iter++) {
        ...
        // and_query(second == 1)
        realm_legacy::Query q1_0 = table.where().equal(col_int1, 1);
        realm_legacy::Query q2_0 = table.where().and_query(q1_0);
        realm_legacy::TableView tv_0 = q2_0.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if (o.get<Int>(col_int1) == 1) {
        ...
        realm_legacy::Query q1_1 = table.where().equal(col_int1, 1);
        realm_legacy::Query q2_1 =
        ...
        // first == 0 || (first == 1 && and_query(second == 1))
        realm_legacy::Query q1_2 = table.where().equal(col_int1, 1);
        realm_legacy::Query q2_2 = table.where().equal(col_int0, 0).Or().equal(col_int0, 1).and_query(q1_2);
        realm_legacy::TableView tv_2 = q2_2.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if (o.get<Int>(col_int0) == 0 || (o.get<Int>(col_int0) == 1 && o.get<Int>(col_int1) == 1)) {
        ...
        realm_legacy::Query q1_3 = table.where().equal(col_int0, 0);
        realm_legacy::Query q2_3 = table.where().and_query(q1_3).Or().equal(col_int0, 1).equal(col_int1, 1);
        realm_legacy::TableView tv_3 = q2_3.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if (o.get<Int>(col_int0) == 0 || (o.get<Int>(col_int0) == 1 && o.get<Int>(col_int1) == 1)) {
        ...
        realm_legacy::Query q2_4 = table.where().equal(col_int0, 1).equal(col_int1, 1);
        realm_legacy::Query q1_4 = table.where().equal(col_int0, 0).Or().and_query(q2_4);
        realm_legacy::TableView tv_4 = q1_4.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if (o.get<Int>(col_int0) == 0 || (o.get<Int>(col_int0) == 1 && o.get<Int>(col_int1) == 1)) {
        ...
        realm_legacy::Query q2_5 = table.where().equal(col_int0, 0).Or().equal(col_int0, 2);
        realm_legacy::Query q1_5 = table.where().equal(col_int0, 1).equal(col_int1, 1);
        realm_legacy::Query q3_5 = table.where().and_query(q2_5).Or().and_query(q1_5);
        realm_legacy::TableView tv_5 = q3_5.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if ((o.get<Int>(col_int0) == 0 || o.get<Int>(col_int0) == 2) ||
                (o.get<Int>(col_int0) == 1 && o.get<Int>(col_int1) == 1)) {
        ...
        realm_legacy::Query q1_6 = table.where().equal(col_int0, 0);
        realm_legacy::Query q2_6 = table.where().equal(col_int1, 1);
        realm_legacy::Query q3_6 = table.where().and_query(q1_6).and_query(q2_6);
        realm_legacy::TableView tv_6 = q3_6.find_all();
        tvpos = 0;
        for (Obj o : table) {
        ...
        // and_query(first == 0 || first == 2) && and_query(first == 1 || second == 1)
        realm_legacy::Query q2_7 = table.where().equal(col_int0, 0).Or().equal(col_int0, 2);
        realm_legacy::Query q1_7 = table.where().equal(col_int0, 1).equal(col_int0, 1).Or().equal(col_int1, 1);
        realm_legacy::Query q3_7 = table.where().and_query(q2_7).and_query(q1_7);
        realm_legacy::TableView tv_7 = q3_7.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if ((o.get<Int>(col_int0) == 0 || o.get<Int>(col_int0) == 2) &&
        ...
        realm_legacy::Query q2_8 = table.where().equal(col_int0, 2);
        realm_legacy::Query q3_8 = table.where().equal(col_int0, 0).Or().and_query(q2_8);
        realm_legacy::Query q4_8 = table.where().equal(col_int1, 0).and_query(q3_8);
        realm_legacy::TableView tv_8 = q4_8.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if (o.get<Int>(col_int1) == 0 && ((o.get<Int>(col_int0) == 0) || o.get<Int>(col_int0) == 2)) {
        ...
        // second == 0 && and_query(first == 0 || and_query(first == 2))
        realm_legacy::Query q2_9 = table.where().equal(col_int0, 2);
        realm_legacy::Query q5_9 = table.where().equal(col_int0, 0);
        realm_legacy::Query q3_9 = table.where().and_query(q5_9).Or().and_query(q2_9);
        realm_legacy::Query q4_9 = table.where().equal(col_int1, 0).and_query(q3_9);
        realm_legacy::TableView tv_9 = q4_9.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if (o.get<Int>(col_int1) == 0 && ((o.get<Int>(col_int0) == 0) || o.get<Int>(col_int0) == 2)) {
        ...
        realm_legacy::Query q2_10 = table.where().equal(col_int0, 0);
        realm_legacy::Query q5_10 = table.where().and_query(q2_10);
        realm_legacy::Query q3_10 = table.where().and_query(q5_10);
        realm_legacy::Query q4_10 = table.where().and_query(q3_10);
        realm_legacy::TableView tv_10 = q4_10.find_all();
        tvpos = 0;
        for (Obj o : table) {
...
TEST(Query_MergeQueriesMonkeyOverloads)
{
    ...
    for (int iter = 0; iter < 5; iter++) {
        ...
        // and_query(second == 1)
        realm_legacy::Query q1_0 = table.where().equal(col_int1, 1);
        realm_legacy::Query q2_0 = table.where() && q1_0;
        realm_legacy::TableView tv_0 = q2_0.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if (o.get<Int>(col_int1) == 1) {
        ...
        // and_query(second == 1)
        realm_legacy::Query q1_10 = table.where().equal(col_int1, 1);
        realm_legacy::Query q2_10 = q1_10 && table.where();
        realm_legacy::TableView tv_10 = q2_10.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if (o.get<Int>(col_int1) == 1) {
                CHECK_EQUAL(o.get_key(), tv_10.get_key(tvpos));
        ...
        // (first == 0 || first == 1) && and_query(second == 1)
        realm_legacy::Query q1_1 = table.where().equal(col_int0, 0);
        realm_legacy::Query q2_1 = table.where().equal(col_int0, 1);
        realm_legacy::Query q3_1 = q1_1 || q2_1;
        realm_legacy::Query q4_1 = table.where().equal(col_int1, 1);
        realm_legacy::Query q5_1 = q3_1 && q4_1;

        realm_legacy::TableView tv_1 = q5_1.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if ((o.get<Int>(col_int0) == 0 || o.get<Int>(col_int0) == 1) && o.get<Int>(col_int1) == 1) {
                CHECK_EQUAL(o.get_key(), tv_1.get_key(tvpos));
        ...
        // and_query(first == 0) || (first == 1 && second == 1)
        realm_legacy::Query q1_3 = table.where().equal(col_int0, 0);
        realm_legacy::Query q2_3 = table.where().equal(col_int0, 1);
        realm_legacy::Query q3_3 = table.where().equal(col_int1, 1);
        realm_legacy::Query q4_3 = q1_3 || (q2_3 && q3_3);
        realm_legacy::TableView tv_3 = q4_3.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if (o.get<Int>(col_int0) == 0 || (o.get<Int>(col_int0) == 1 && o.get<Int>(col_int1) == 1)) {
                CHECK_EQUAL(o.get_key(), tv_3.get_key(tvpos));
        ...
        realm_legacy::Query q1_30 = table.where().equal(col_int0, 0);
        realm_legacy::Query q3_30 = table.where().equal(col_int1, 1);
        realm_legacy::Query q4_30 = table.where().equal(col_int0, 0) || (table.where().equal(col_int0, 1) && q3_30);
        realm_legacy::TableView tv_30 = q4_30.find_all();
        tvpos = 0;
        for (Obj o : table) {
            if (o.get<Int>(col_int0) == 0 || (o.get<Int>(col_int0) == 1 && o.get<Int>(col_int1) == 1)) {
...
TEST(Query_IntIndex)
{
    ...
    q = origin->link(col_link).column<Int>(col) == realm_legacy::null();
    cnt = q.count();
...
TEST(Query_StringIndexNull)
{
    ...
    auto q = origin->link(col_link).column<String>(col) == realm_legacy::null();
    auto cnt = q.count();
    CHECK_EQUAL(cnt, nulls);
}
...
TEST(Query_size)
{
    ...
    q = binaries.size() == realm_legacy::null();
    tv = q.find_all();
...
struct AggregateValues<Decimal128> {
    ...
    static const constexpr realm_legacy::null null = realm_legacy::null();
};
...
TEST(Query_TwoColsEqualVaryWidthAndValues)
{
    ...
    realm_legacy::TableView t1 = table.where().equal(col_int0, col_int1).find_all();
    realm_legacy::TableView t2 = table.where().equal(col_int2, col_int3).find_all();
    realm_legacy::TableView t3 = table.where().equal(col_int4, col_int5).find_all();

    realm_legacy::TableView t4 = table.where().equal(col_float6, col_float7).find_all();
    realm_legacy::TableView t5 = table.where().equal(col_double8, col_double9).find_all();
...
TEST(Query_TwoCols0)
{
    ...
    realm_legacy::TableView t1 = table.where().equal(col0, col1).find_all();
    CHECK_EQUAL(50, t1.size());

    realm_legacy::TableView t2 = table.where().less(col0, col1).find_all();
