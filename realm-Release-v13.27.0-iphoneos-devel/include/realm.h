...
typedef enum realm_column_attr {
    // Values matching `realm_legacy::ColumnAttr`.
...
typedef enum realm_property_type {
    // Values matching `realm_legacy::ColumnType`.
...
/* Logging */
// equivalent to realm_legacy::util::Logger::Level in util/logger.hpp and must be kept in sync.
...
/**
 * Get the `realm_legacy::Schema*` pointer for this realm.
 *
 * This is intended as a migration path for users of the C++ Object Store API.
 *
...
/**
 * Create a `realm_list_t` from a pointer to a `realm_legacy::List`, copy-constructing
 * the internal representation.
 *
 * @param plist A pointer to an instance of `realm_legacy::List`.
 * @param n Must be equal to `sizeof(realm_legacy::List)`.
 * @return A non-null pointer if no exception occurred.
 */
RLM_API realm_list_t* _realm_list_from_native_copy(const void* plist, size_t n);

/**
 * Create a `realm_list_t` from a pointer to a `realm_legacy::List`, move-constructing
 * the internal representation.
 *
 * @param plist A pointer to an instance of `realm_legacy::List`.
 * @param n Must be equal to `sizeof(realm_legacy::List)`.
 ...
 * @param out_index the index in the list where the value has been found or realm_legacy::not_found.
...
/**
 * Create a `realm_set_t` from a pointer to a `realm_legacy::object_store::Set`,
 * copy-constructing the internal representation.
 *
 * @param pset A pointer to an instance of `realm_legacy::object_store::Set`.
 * @param n Must be equal to `sizeof(realm_legacy::object_store::Set)`.
 * @return A non-null pointer if no exception occurred.
 */
...
/**
 * Create a `realm_dictionary_t` from a pointer to a `realm_legacy::object_store::Dictionary`,
 * copy-constructing the internal representation.
 *
 * @param pdict A pointer to an instance of `realm_legacy::object_store::Dictionary`.
 * @param n Must be equal to `sizeof(realm_legacy::object_store::Dictionary)`.
 * @return A non-null pointer if no exception occurred.
 */
 ...
 *  @param out_index the index where the object has been found, or realm_legacy::not_found
