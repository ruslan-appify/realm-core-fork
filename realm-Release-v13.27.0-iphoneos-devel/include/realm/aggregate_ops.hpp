...
namespace realm_legacy::aggregate_operations {
...
class Sum {
public:
    using ResultType = typename realm_legacy::ColumnSumType<T>;
...
class Average {
public:
    using ResultType = typename std::conditional<realm_legacy::is_any_v<T, Decimal128, Mixed>, Decimal128, double>::type;
