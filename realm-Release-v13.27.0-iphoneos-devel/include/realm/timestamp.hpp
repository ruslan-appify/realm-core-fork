...
public:
    ...
    constexpr Timestamp(realm_legacy::null) {}
...
namespace std {
template <>
struct numeric_limits<realm_legacy::Timestamp> {
    static constexpr bool is_integer = false;
    static constexpr realm_legacy::Timestamp min()
    {
        return realm_legacy::Timestamp(numeric_limits<int64_t>::min(), 0);
    }
    static constexpr realm_legacy::Timestamp lowest()
    {
        return realm_legacy::Timestamp(numeric_limits<int64_t>::lowest(), 0);
    }
    static constexpr realm_legacy::Timestamp max()
    {
        return realm_legacy::Timestamp(numeric_limits<int64_t>::max(), 0);
    }
};
}
