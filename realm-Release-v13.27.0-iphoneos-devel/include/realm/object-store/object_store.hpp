...
public:
    ...
    static realm_legacy::TableRef table_for_object_type(Group& group, StringData object_type);
    static realm_legacy::ConstTableRef table_for_object_type(Group const& group, StringData object_type);
