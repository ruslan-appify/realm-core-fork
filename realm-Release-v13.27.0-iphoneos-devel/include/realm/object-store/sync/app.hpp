...
public:
    ...
    public:
        ...
        /// @param completion A callback to be invoked once the call is complete.
        void fetch_api_key(const realm_legacy::ObjectId& id, const std::shared_ptr<SyncUser>& user,
                           util::UniqueFunction<void(UserAPIKey&&, util::Optional<AppError>)>&& completion);
        ...
        /// @param completion A callback to be invoked once the call is complete.
        void delete_api_key(const realm_legacy::ObjectId& id, const std::shared_ptr<SyncUser>& user,
        ...
        /// @param user The user to perform this operation.
        /// @param completion A callback to be invoked once the call is complete.
        void enable_api_key(const realm_legacy::ObjectId& id, const std::shared_ptr<SyncUser>& user,
                            util::UniqueFunction<void(util::Optional<AppError>)>&& completion);
        ...
        /// @param user The user to perform this operation.
        /// @param completion A callback to be invoked once the call is complete.
        void disable_api_key(const realm_legacy::ObjectId& id, const std::shared_ptr<SyncUser>& user,
                             util::UniqueFunction<void(util::Optional<AppError>)>&& completion);
