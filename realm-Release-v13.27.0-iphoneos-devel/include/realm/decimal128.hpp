...
namespace std {
template <>
struct numeric_limits<realm_legacy::Decimal128> {
    static constexpr bool is_integer = false;
    static realm_legacy::Decimal128 lowest() noexcept
    {
        return realm_legacy::Decimal128("-Inf");
    }
    static realm_legacy::Decimal128 max() noexcept
    {
        return realm_legacy::Decimal128("+Inf");
    }
};
