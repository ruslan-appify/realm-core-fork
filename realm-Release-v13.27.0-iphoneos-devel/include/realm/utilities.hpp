...
// realm_legacy::is_any<T, U1, U2, U3, ...> ==
...
// Use realm_legacy::safe_equal() instead of std::equal() if one of the parameters can be a null pointer.
...
// Use realm_legacy::safe_copy_n() instead of std::copy_n() if one of the parameters can be a null pointer. See the
