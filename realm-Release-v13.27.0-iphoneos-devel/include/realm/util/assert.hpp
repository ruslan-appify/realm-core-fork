...
#define REALM_ASSERT_RELEASE(condition)                                                                              \
    (REALM_LIKELY(condition) ? static_cast<void>(0)                                                                  \
                             : realm_legacy::util::terminate("Assertion failed: " #condition, __FILE__, __LINE__))
...
#define REALM_ASSERT_RELEASE_EX(condition, ...)                                                                      \
    (REALM_LIKELY(condition) ? static_cast<void>(0)                                                                  \
                             : realm_legacy::util::terminate_with_info("Assertion failed: " #condition, __LINE__, __FILE__, \
...
#define REALM_ASSERT_3(left, cmp, right)                                                                             \
    (REALM_LIKELY((left)cmp(right)) ? static_cast<void>(0)                                                           \
                                    : realm_legacy::util::terminate("Assertion failed: "                                    \
                                                             "" #left " " #cmp " " #right,                           \
...
#define REALM_UNREACHABLE() realm_legacy::util::terminate("Unreachable code", __FILE__, __LINE__)
#ifdef REALM_COVER
