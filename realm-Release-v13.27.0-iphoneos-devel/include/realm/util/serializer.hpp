...
template <> std::string print_value<>(realm_legacy::null);
template <> std::string print_value<>(StringData);
template <> std::string print_value<>(realm_legacy::Timestamp);
template <>
std::string print_value<>(realm_legacy::ObjectId);
template <>
std::string print_value<>(realm_legacy::ObjKey);

std::string print_value(realm_legacy::ObjLink, Group*);

template <>
std::string print_value<>(realm_legacy::UUID);
template <>
std::string print_value<>(realm_legacy::TypeOfValue);

#if REALM_ENABLE_GEOSPATIAL
template <>
std::string print_value<>(const realm_legacy::Geospatial&);
#endif // REALM_ENABLE_GEOSPATIAL
