...
public:
    ...
    Bson(realm_legacy::Timestamp) noexcept;
    Bson(Decimal128) noexcept;
    Bson(ObjectId) noexcept;
    Bson(realm_legacy::UUID) noexcept;
    ...
    explicit operator realm_legacy::Timestamp() const
    {
    ...
    explicit operator realm_legacy::UUID() const
    {
...
private:
    ...
    union {
        ...
        MaxKey max_key_val;
        MinKey min_key_val;
        realm_legacy::Timestamp date_val;
        realm_legacy::UUID uuid_val;
        // ref types
...
inline Bson::Bson(realm_legacy::Timestamp v) noexcept
{
...
inline Bson::Bson(realm_legacy::UUID v) noexcept
{
